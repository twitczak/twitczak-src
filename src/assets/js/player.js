...
(function ($) {
    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1"' +
            ' xmlns="http://www.w3.org/2000/svg" width="60" height="60" data-play="playable" class="not-started' +
            ' playable" shape-rendering="geometricPrecision">',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="47.45" stroke="#212529" stroke-opacity="1"' +
                ' stroke-linecap="square" fill="none" stroke-width="2"/>',
                '<circle class="precache-bar" cx="50" cy="50" r="47.45" stroke="#cccccc" stroke-opacity="1"' +
                ' stroke-linecap="square" fill="none" stroke-width="1" transform="rotate(-90 50 50)"/>',
                '<circle class="progress-bar" cx="50" cy="50" r="47.45" stroke="#02fff0" stroke-opacity="1"' +
                ' stroke-linecap="square" fill="none" stroke-width="3" transform="rotate(-90 50 50)"/>',
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="45" stroke="none" fill="#212529" opacity="0.0" pointer-events="all"/>',
                '<g class="control pause">',
                '<line x1="45" y1="40" x2="45" y2="60" stroke="#212529" fill="none" stroke-width="8"/>',
                '<line x1="55" y1="40" x2="55" y2="60" stroke="#212529" fill="none" stroke-width="8"/>',
                '</g>',
                '<g class="control play">',
                '<polygon points="43,38 63,50 43,62" fill="#212529" stroke-width="0"></polygon>',
                '</g>',
                '<g class="control stop">',
                '<rect x="35" y="35" width="30" height="30" stroke="#212529" fill="none" stroke-width="1"/>',
                '</g>',
                '</svg>'];
